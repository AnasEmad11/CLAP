...
def main(args):
    ...
    agents_data_train =[[] for i in range(len(scence_split))]
    for i, (class_name , indices) in enumerate(scence_split.items()):
        agents_data_train[i] = indices
    ...
    with open(f"C:/Users/User/PycharmProjects/FL_AD/data/ucf/scene_video_num_partition_{clients_num}_V3.pkl", "wb") as f:
    ...
    with open(f"C:/Users/User/PycharmProjects/FL_AD/data/ucf/scene_partition_{clients_num}_V3.pkl", "wb") as f:
    ...
    with open(f"C:/Users/User/PycharmProjects/FL_AD/data/ucf/scene_partition_chain_{clients_num}_V3.pkl", "wb") as f:
        pickle.dump(partition, f)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-cn", "--client_num", type=int, default=11)
