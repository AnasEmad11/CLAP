...
def main(args):
    ...
    train_list = list(open('C:/Users/User/PycharmProjects/FL_AD/UCF_Train_ten_crop_i3d_complete_ratio_v2.txt'))
    ...
    with open(f"C:/Users/User/PycharmProjects/FL_AD/data/ucf/ratio_video_num_partition_{clients_num}_V3.pkl", "wb") as f:
    ...
    for i in range(clients_num):
        ...
        for k,v in enumerate(partition["data_indices"][i]["train"]):
            from_id = int(train_list[v].split('\n')[0].split(',')[1])-85902
            to_id = int(train_list[v].split('\n')[0].split(',')[2])-85902
    ...
    with open(f"C:/Users/User/PycharmProjects/FL_AD/data/ucf/ratio_partition_{clients_num}_V3.pkl", "wb") as f:
    ...
    with open(f"C:/Users/User/PycharmProjects/FL_AD/data/ucf/ratio_partition_chain_{clients_num}_V3.pkl", "wb") as f:
        pickle.dump(partition, f)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-trv", "--train_vid_num", type=int, default=1317)
